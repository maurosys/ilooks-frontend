...
const MyApp = ({Component, pageProps}: AppProps) => {
  ...
  Router.events.on("routeChangeStart", (url) => {
    ...
    div.style = "width: 100%;height: 100%;background: rgb(98 98 98 / 30%);position: fixed;top: 0;left: 0;z-index: 9999;display: flex; justify-content: center; align-items: center;";
