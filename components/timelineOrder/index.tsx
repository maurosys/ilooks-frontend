...
const TimeLineOrder = ({ orderStatus }: TimeLineOrderProps) => {
  return (
    <div className="timeline">
      <div
        className={`circle ${
          rulesActives[orderStatus].orderPlaced && "active"
        }`}
      >
      ...
      <div
        className={`circle ${
          rulesActives[orderStatus].reservedPayment && "active"
        }`}
      >
        <div className="icon"></div>
        <div className="labels">
      ...
      <div
        className={`circle ${
          rulesActives[orderStatus].withCarrier && "active"
        }`}
      >
        <div className="icon"></div>
        <div className="labels">
      ...
      <div
        className={`circle ${
          rulesActives[orderStatus].onCarriage ? "active" : ""
        }`}
      >
        <div className="icon"></div>
        <div className="labels">
      ...
      <div
        className={`circle end ${
          rulesActives[orderStatus].delivered && "active"
        }`}
      >
        <div className="icon"></div>
